...
public class OpenApiConfig {
    ...
    @Bean
    public OpenAPI marketplaceAdminServiceOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("Marketplace · Admin Service API")
                        .description("Модерация пользователей, удаление товаров и журнал аудита. Доступ — только администратору.")
                        .version("v1")
                        .contact(new Contact()
